...
from .pe_targets import PETargets, STATE_FIPS
...
class CalibrationTarget:
    ...
    name: str
    target_value: float
    column: Optional[str] = None  # Column to sum for this target
    filter_col: Optional[str] = None  # Column to filter on
    filter_val: Optional[str] = None  # Value to filter for
...
class UnifiedCalibrator:
    ...
    def __init__(
        self,
        geographic_targets: Optional[Dict[str, float]] = None,
